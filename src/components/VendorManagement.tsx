  ...
  const renderOverview = () => (
    <div className="space-y-6">
              ...
              <div key={vendorId} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 capitalize">{vendor.service_category?.replace('_', ' ') || 'N/A'}</p>
                  </div>
                </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          {vendors.sort((a, b) => (b.rating || 4.5) - (a.rating || 4.5)).slice(0, 5).map((vendor, index) => (
            <div key={vendor.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-900">{vendor.rating || '4.5'}</span>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gray-900">{vendor.performanceMetrics?.completedJobs || '0'} jobs</p>
                <p className="text-xs text-gray-600">{vendor.performanceMetrics?.onTimeDelivery || '95'}% on-time</p>
              </div>
            </div>
          ))}
        </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{selectedVendor.service_category?.replace('_', ' ') || 'N/A'}</p>
                  </div>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <p className="text-2xl font-bold text-blue-600">{selectedVendor.performanceMetrics?.completedJobs || '0'}</p>
                      <p className="text-blue-600 text-sm">Completed</p>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                      <p className="text-2xl font-bold text-green-600">{selectedVendor.performanceMetrics?.onTimeDelivery || '95'}%</p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 capitalize">{selectedContract.service_category?.replace('_', ' ') || 'N/A'}</p>
                  </div>
                  <div>
            ...
            <div key={vendor.id} className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all duration-200">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getVendorTypeColor(vendor.service_category || '')}`}>
                    {vendor.service_category?.replace('_', ' ').toUpperCase() || 'N/A'}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(vendor.is_active ? 'active' : 'inactive')}`}>
                    {vendor.is_active ? 'ACTIVE' : 'INACTIVE'}
                  </span>
                  <span className="text-xs text-gray-500">
                    {vendor.performanceMetrics?.completedJobs || '0'} jobs completed
                  </span>
                </div>
              </div>
            </div>
            ...
            {vendors.map((vendor) => (
              <div key={vendor.id} className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <p className="text-2xl font-bold text-blue-600">{vendor.performanceMetrics?.totalJobs || '0'}</p>
                    <p className="text-blue-600">Total Jobs</p>
                  </div>
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    <p className="text-2xl font-bold text-green-600">{vendor.performanceMetrics?.completedJobs || '0'}</p>
                    <p className="text-green-600">Completed</p>
                  </div>
                  <div className="text-center p-3 bg-yellow-50 rounded-lg">
                    <p className="text-2xl font-bold text-yellow-600">{vendor.performanceMetrics?.averageRating || '4.5'}</p>
                    <p className="text-yellow-600">Avg Rating</p>
                  </div>
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <p className="text-2xl font-bold text-purple-600">{vendor.performanceMetrics?.onTimeDelivery || '95'}%</p>
