...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Don't set loading to false if login was successful - let the app redirect
  };

  const handleDemoLogin = (userType: 'super_admin' | 'staff') => {
    if (userType === 'super_admin') {
      setEmail('rahulpradeepan77@gmail.com');
      setPassword('123456');
      toast.success('Demo credentials loaded for Super Admin');
    } else {
      setEmail('meenakshi@educare.com');
      setPassword('123456');
      toast.success('Demo credentials loaded for Staff User');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          <p>© 2024 Servigens CRM. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
