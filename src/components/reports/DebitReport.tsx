...
const DebitReport: React.FC = () => {
  ...
  const loadDebitData = async () => {
    try {
      setLoading(true);
      const transactions = await dbHelpers.getDebitTransactionsByDateRange(dateFrom, dateTo);
      
      if (!transactions) {
        setData({
          transactions: [],
          summary: { totalDebits: 0, transactionCount: 0, averageDebit: 0, largestDebit: 0 },
      ...
      // Transform data
      const debitTransactions: DebitTransaction[] = transactions.map(t => ({
        id: t.id,
      ...
      const averageDebit = transactionCount > 0 ? totalDebits / transactionCount : 0;
      const largestDebit = Math.max(...debitTransactions.map(t => t.amount), 0);

      // Payment method breakdown
      const paymentMethodBreakdown = debitTransactions.reduce((acc, t) => {
      ...
      // Status breakdown
      const statusBreakdown = debitTransactions.reduce((acc, t) => {
      ...
      // Monthly trend
      const monthlyTrend = debitTransactions.reduce((acc, t) => {
      ...
      setData({
        ...
        summary: { totalDebits, transactionCount, averageDebit, largestDebit },
        paymentMethodBreakdown,
        statusBreakdown,
        monthlyTrend
      });
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 mt-1">All debit transactions and payables</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">
                AED {data?.summary.totalDebits.toLocaleString('en-US', { minimumFractionDigits: 2 }) || '0.00'}
              </p>
            </div>
            <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center">
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">Debit Transactions</h2>
        ...
        {filteredTransactions.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No debit transactions found</h3>
